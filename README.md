...
| [Face API Explorer](Documentation/FaceAPIExplorer.md)          | A playground for the Face APIs used for extraction a series of face-related attributes, such as head pose, gender, age, emotion, facial hair, and glasses, as well as face identification. | Windows 10 Face Tracking; Face API; Bing Image Search API; Bing AutoSuggestion API |
