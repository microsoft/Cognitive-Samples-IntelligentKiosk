...
| [Visual Alert Builder](Documentation/VisualAlertBuilder.md)          | Shows how to use Custom Vision Service to quickly create an image classifier to detect visual states, and how to process frames from a web camera to alert when those states are detected. | Custom Vision API |
