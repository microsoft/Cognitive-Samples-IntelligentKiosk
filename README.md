...
| [Ink Recognizer Explorer](Documentation/InkRecognizerExplorer.md)          | An example of recognizing digital handwriting and common shapes with ink canvas and form-filling scenarios  | Ink Recognizer API  |
