...
| ---------------------------- | -------- | ----------------  |
| [Anomaly Detector](Documentation/AnomalyDetectorDemo.md)      | A realtime workflow for processing data from a microphone to show point anomalies exported by Microsoft Anomaly Detector Service. | Anomaly Detector API |
