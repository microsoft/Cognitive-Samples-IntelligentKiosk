...
| [Custom Vision Setup](Documentation/CustomVisionSetup.md)      | Shows how to train the machine learning model behind the Custom Vision Service. | Custom Vision API, Bing Image Search API;  Bing AutoSuggestion API |
