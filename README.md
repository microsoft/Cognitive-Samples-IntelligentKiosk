...
| [Custom Vision Setup](Documentation/CustomVisionSetup.md)      | Shows how to train a machine learning model behind the Custom Vision Service. | Custom Vision API, Bing Image Search API;  Bing AutoSuggestion API |
